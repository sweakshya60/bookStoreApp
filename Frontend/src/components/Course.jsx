...
function Course() {
  ...
  useEffect(() => {
    const getBook = async () => {  // Fixed typo: "asyc" -> "async"
      try {
        const res = await axios.get('http://localhost:4001/book');
        console.log(res.data);
        setBook(res.data);  // Fixed typo: "setbook" -> "setBook"
      } catch (error) {
        console.log(error);
      }
    };
    ...
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4">
      <div className="mt-28 items-center justify-center text-center">
        ...
        <p className="mt-12">
          ...
          quibusdam, perspiciatis, explicabo sequi fugiat amet animi eos aut. Nobis
